...
const Navbar = () => {
  ...
  return (
    <nav className=" px-6  py-6 md:px-10 xl:px-16 bg-black bg-opacity-20  font-inter flex justify-between  items-center ">
      {/* Left side */}
      <div className="flex gap-2   items-center">
        ...
        <div className="z-20 flex flex-col">
          <p
            className={`text-black   font-[700] leading-none md:text-2xl  xl:text-[32px]  `}
          >
            Elabd Tech<span className="text-[#35D373]">.</span>
          </p>
          <p
            className={`text-[#35D373]  leading-none text-[16px] lg:font-[500]`}
          >
            Serving the World
          </p>
        </div>
      ...
      <div className="hidden xl:block ">
        <Link href={"/careers/home"}>
          <div className="bg-black flex justify-center items-center px-10 py-3   rounded-full">
            <p className="text-[16px] text-white font-[500]">Careers </p>
          </div>
        </Link>
      </div>

      {showNavLinks && (
        <div className="px-2 flex items-center justify-around pt-2 pb-4 space-y-2 z-10 h-48   w-[93%] absolute bg-[#35D373] top-[7rem] left-8  xl:hidden">
          <div className=" p-5 ">
            <li>
              <Link href={"/services"} legacyBehavior>
